...
sources = [
    os.path.join(current_directory, "mxfp8_group_gemm.cu"),
...
setup(
    name=name,
    version="0.1.0",
    packages=["hhw_mxfp8_group_gemm"],
    package_dir={"hhw_mxfp8_group_gemm": "."},
    ext_modules=[
        CUDAExtension(
            "hhw_mxfp8_group_gemm._C",
            sources=sources,
