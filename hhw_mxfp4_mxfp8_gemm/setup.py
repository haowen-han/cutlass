...
sources = [
    os.path.join(current_directory, "mxfp4_mxfp8_gemm.cu"),
...
setup(
    name=name,
    version="0.1.0",
    packages=["hhw_mxfp4_mxfp8_gemm"],
    package_dir={"hhw_mxfp4_mxfp8_gemm": "."},
    ext_modules=[
        CUDAExtension(
            "hhw_mxfp4_mxfp8_gemm._C",
            sources=sources,
